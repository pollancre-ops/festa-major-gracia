const CACHE='festigracia-v14-3';
const ASSETS=['./','index.html','style.css?v=14.3.0','app.js?v=14.3.0','activities.json?v=14.3.0','streets.json?v=14.3.0','manifest.json','manifest-private.json','icon.svg'];
